...
/*   Updated: 2021/11/16 14:56:39 by jodufour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			ft_atoi(char const *str) __attribute__((nonnull));
...
t_hhint		ft_atohhi(char const *str) __attribute__((nonnull));

t_hhuint	ft_atohhu(char const *str) __attribute__((nonnull));

t_hint		ft_atohi(char const *str) __attribute__((nonnull));

t_huint		ft_atohu(char const *str) __attribute__((nonnull));

t_uint		ft_atou(char const *str) __attribute__((nonnull));
...
t_lint		ft_atoli(char const *str) __attribute__((nonnull));

t_luint		ft_atolu(char const *str) __attribute__((nonnull));

t_llint		ft_atolli(char const *str) __attribute__((nonnull));

t_lluint	ft_atollu(char const *str) __attribute__((nonnull));
