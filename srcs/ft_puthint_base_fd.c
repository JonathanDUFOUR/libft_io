...
/*   Updated: 2021/11/20 08:11:08 by jodufour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_io.h"

int	ft_puthint_base_fd(t_hint const nb, const char *base, int const fd)
{
	t_huint	abs;
	char	digit;
	int		base_len;
	...
	if (abs / base_len)
		return (ft_puthint_base_fd(abs / base_len, base, fd)
